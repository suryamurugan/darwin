...
import prizeIcon from "../temp/brief_icon.svg";
    ...
    <div style={{ background: "white" }}>
      ...
      <div id='bulletItems' style={{ width: "70%", margin: "auto" }}>
        <p style={{ textAlign: "left" }}>
          ...
          <br />
          <br />
          It is with this objective that Tata Structura has endeavoured to
          create an iconic symbol that articulates the Idea of India for today
          and tomorrow. A quest to create a landmark that will never cease in
          its intent to amaze, regardless of the era in which it is seen.
          Because even as it remains in permanence, it will always remain true
          to its purpose of changing times.
          <br />
          <br />
          And who better to do that than the people who construct the nation.
          People who recognise challenges as beauty in opportunity. People who
          are not restricted by space to embody the beauty in spirit. People who
          ...
          India, a seminal competition to celebrate this milestone and give
          India its most distinguishable symbol of ‘The Shape of Things to
          Come’.
          <br />
          <br />
          ...
          portray the dynamics of this transformational reality and present it
          not just to the global audience, but to ourselves as well? How do we
          capture the beauty of this momentum in a medium that will continue to
          have the ability to inspire us forever?
        </p>
      </div>
      <br />
      <br />
    ...
    <div style={{ background: "white" }}>
      ...
      <div id='bulletItems' style={{ width: "70%", margin: "auto" }}>
        <p style={{ textAlign: "left" }}>
          ...
          One of the most unique characteristics of steel hollow sections is
          that it distinguishes itself from other building materials are the
          array of applications that it caters to. The spatial distribution of
          material around the axis of these steel hollow sections gives it
          several magical qualities. This not only gives designers greater
          flexibility to shape structures but also makes it convenient and
          easier to express their creativity. In short, strong yet immensely
          versatile.
          <br /> <br />
          It is this versatility that makes steel hollow sections an ideal
          medium of creative expression. Its versatility and strength help
          construct a spatial vocabulary that underlines efficiency and
          intelligence of process and program. It also speaks of a collaborative
          approach wherein multidisciplinary design professionals combine to
          develop a cohesive vision. Much like the Idea of India.
          <br />
          <br />
          <br />
          {/*SCROLL BAR SHOULD BE ADDED*/}
          ...
          <tr>
            ...
            <td>
              The participant is free to imagine the scope of Notions of India
              as per their visualization of the concept.
            </td>
          </tr>
          <br />
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              medium of the design. It may be combined with any other media
              (wood, glass, technology etc.) but hollow sections must remain the
              main medium conceptually and visually.
            </td>
          </tr>
          <br />
          <tr>
            ...
            <td>
              For any reasons, if the participant wishes to choose another
              primary material, then he/she must provide a valid reason for it.
          ...
          <tr>
            ...
            <td>
              The Notions of India must adhere to ethical practices in all
          ...
          <tr>
            ...
            <td>
              The Notions of India must explore and exploit the potential of
              Steel hollow sections through an innovative approach.
            </td>
          </tr>
          <br />
          <tr>
